...
class Form_model extends CI_Model {
    ...
    function get_multipledropdown_formselection()
    {
		...
		$result = $this->db->select('id_campaign, id_form, form.nombre')->from('campaign_form')->join('form', 'form.id = campaign_form.id_form')->where('id_campaign', $_SESSION['idofcampaign'])->get(); //$idcampaign
                //$result = $this->db->get();
    ...
    function update_entry($data)
    {
        ...
        //$this->estatus = $data['estatus'];
        //$this->date    = time();
        $this->db->update('form', $this, array('id' => $data['id']));
    }
    //-------------------------------------------------------------------------------------------
