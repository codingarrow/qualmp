      ...
      <section id="main-content">
	    ...
	    <?php else:?>
             ...
             <div class="row">
			      ...
			      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      <a href="<?php echo site_url();?>/create/newtopic" data-toggle="modal" class="btn btn-success">New Topics</a>
                          </header>
                          <div class="panel-body">
					...
					<th>&nbsp;</th>
					    ...
					    $id = $r->topic_id;
		                            $rating_topic = $r->ratingtopic; //$this->surveyform_model->get_ratingtopic($id);
					    $update ='<a title="Edit '.$r->ratingtopic.'" alt="Edit '.$rating_topic.'" href="'.  site_url().'/create/index_topic/'.$id.'"><i class="icon-pencil"></i></a> ';
					    $purge  ='<a title="Delete '.$r->ratingtopic.'" alt="Delete '.$rating_topic.'" onclick="return confirm(\'Delete this record?\');" href="'.  site_url().'/create/delete_topic/'.$id.'" role="button" data-toggle="modal"><i class="icon-remove"></i></a>';	
					    ?>
                                  <tr>
						<td><?php echo $id; ?>&nbsp;</td>
						<td><?php echo $rating_topic; ?>&nbsp;</td>
