...
class loginActions extends sfActions
{
	...
	{
		global $mrUser;
	  //echo '<script>alert("eMLogin "'.$_SERVER['PHP_SELF'].')</script>';	
	  //if (isset($_REQUEST["recording_file_url"]))
	  if ($_SERVER['PHP_SELF'] == "/web/system.php/voicelogs/play" && isset($_REQUEST["filepath"]) )
	  {
	...
	{
	  //echo '<script>alert("eIndex ")</script>';	
