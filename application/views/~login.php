...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $base_url; ?>assets/lib/bootstrap/css/bootstrap-responsive.css">
      ...
      <div class="navbar">
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <a class="brand" href="index.html"><span class="first">Quality Management</span> <span class="second">Portal</span></a>
            </div>
        </div>
    </div>
        ...
        <div class="block">
            ...
            <div class="block-body">
                ...
                <form action="<?php echo site_url();?>/login/login_user" method="post" accept-charset="utf-8">
                    ...
                    <input autofocus name="email" id="email" type="text" class="span12">
                    <label>Password</label>
                    <input name="password" id="password" type="password" class="span12">
                    <?php //<a href="index.html" class="btn btn-primary pull-right">Sign In</a> ?>
					<button class="btn btn-primary ewButton" name="btnsubmit" id="btnsubmit" type="submit">Sign In</button>
                    <?php //<label class="remember-me"><input type="checkbox"> Remember me</label> ?>
