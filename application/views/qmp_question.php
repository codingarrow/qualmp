                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              Questions List
			      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      <a href="<?php echo site_url();?>/create/newquestion" data-toggle="modal" class="btn btn-success">New Questions</a>
                          </header>
                          <div class="panel-body">
					...
					<th>&nbsp;</th>
					    ...
					    $id = $r->categoryid;
					    $update ='<a title="Edit '.$r->category.'" alt="Edit '.$r->category.'" href="'.  site_url().'/create/index_question/'.$id.'"><i class="icon-pencil"></i></a> ';
					    $purge  ='<a title="Delete '.$r->category.'" alt="Delete '.$r->category.'" onclick="return confirm(\'Delete this record?\');" href="'.  site_url().'/create/delete_question/'.$id.'" role="button" data-toggle="modal"><i class="icon-remove"></i></a>';	
		                            $rating_topic = $this->surveyform_model->get_ratingtopic($id);
					    ?>
                                  <tr>
						<td><?php echo $id; ?>&nbsp;</td>
