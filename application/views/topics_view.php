...
<div class="row">
    ...
    <form class="form-horizontal tasi-form" id="tab" method="POST" action="<?php echo $_SESSION['host_']?>index.php/create/edit_topics/">
	
		<div class="form-group">
          <div class="col-lg-offset-2 col-lg-10">		
			<button class="btn btn-primary"><i class="icon-save"></i> Save</button>
			<!-- #myModal-->
			<a href="<?php echo site_url();?>/create/viewsite_topic" data-toggle="modal" class="btn btn-success">Cancel</a>
		  </div>
		  <!--div class="btn-group">
		  </div-->
		</div>
	...
	<div class="form-group">
	<input type="hidden" name="id" value="<?php echo $entry->topic_id; ?>"/>
	...
	<div class="form-group">
        <label for="ratingtopic" class="col-lg-2 col-sm-2 control-label">Topic *</label>
		<div class="col-lg-10">
		<input class="form-control" id="ratingtopic" name="ratingtopic" type="text" value="<?php echo $entry->ratingtopic; ?>" > <?php echo form_error('ratingtopic'); ?>
		</div>
	</div>
