<?php //include('templates/header.php'); ?>
    ...
    <form action="<?php echo $_SESSION['host_']?>index.php/crmcontroller/search_call_list/" class="form-horizontal tasi-form" id="tab" method="POST">
						     <?php
							 /*
		...
		<!--span id=\"el1_qmp_settings_copy\" class=\"qmp_settings_copy\"-->
		                              <a class=\"ewRowLink ewCopy\" data-caption=\"Rate this call ".$r->call_id."\" href=\"".site_url()."/crmcontroller/search_call_details?call_id=".$r->call_id."\">
									    <img data-phrase=\"CopyLink\" src=\"".base_url()."assets/img/smallphone.png\" style=\"width:45px; height:45px;\" width=\"16\" height=\"16\" style=\"border: 0;\" alt=\"Rate this call\" title=\"Rate this call\">
									  </a>
								   <!--/span-->";					    
					    ?>
                                  <tr>
						...
						<td><?php echo $r->hangup_first; ?>&nbsp;</td>
						<td><?php echo $r->user_id; ?>&nbsp;</td>
						<td><?php echo $r->disposition_code; ?>&nbsp;</td>
						<td><?php echo $r->transfer_to; ?>&nbsp;</td>
						<td><?php echo $r->setup_time; ?>&nbsp;</td>
						<td><?php echo $r->ringing_time; ?>&nbsp;</td>
						<td><?php echo $r->calltime; ?>&nbsp;</td>
						<td><?php echo $r->wrap_time; ?>&nbsp;</td>
						<td><?php echo $r->percentqualityscore; ?>&nbsp;</td>
                                  </tr>
					    <?php endforeach;?>
				    <!--tr>
					<td colspan="18"></td>
			    ...
			    <table cellpadding="0" cellspacing="0" border="0" id="hidden-table-info">
				   <tr>
				       <td colspan="18"><?php echo $links; ?></td>
				   </tr>
			    </table>
