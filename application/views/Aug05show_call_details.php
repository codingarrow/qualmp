			...
			if ( strlen($call_id) < 3 )
			  {
                  ...
                  <div class="col-md-12">
                              ...
                              <div class="col-md-6">
                                <section class="panel">
                                            <div class="form-group">
                                                <label class="col-lg-2 col-sm-2 control-label">Call ID</label>
                    ...
                    <div class="col-md-6">
                      <section class="panel">
                                  <div class="form-group">
                                                <label class="col-lg-2 col-sm-2 control-label">Call Time</label>
                    ...
                    <div class="col-md-6">
                      <section class="panel">
                                  ...
                                  <div class="form-group">
                                                <label class="col-lg-2 col-sm-2 control-label">Customer ID</label>
                                          <p class="help-block">Example block-level help text here.</p>
                                  </div>
                      </section>
                    </div>
                          ...
                          <!--div class="panel-body"-->
                              <div class="col-sm-6">
                                ...
                                <table class="table table-hover">
                                        ...
                                        <tr>
                                                <td>Call ID</td>
                                                <td>Did the agent offer assistance to the caller?</td>
                                        </tr>
                                        <tr>
                                                <td>Call Date</td>
                                                <td>If the </td>
