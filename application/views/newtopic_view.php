...
<div class="row">
    ...
    <form class="form-horizontal tasi-form" id="tab" method="POST" action="<?php echo $_SESSION['host_']?>index.php/create/input_topic/">
	...
	<div class="form-group">
		...
		<div class="col-lg-10">
		<input class="form-control" id="ratingtopic" name="ratingtopic" type="text" value="<?php echo set_value('ratingtopic'); ?>" > <?php echo form_error('ratingtopic'); ?>
		</div>
	</div>
