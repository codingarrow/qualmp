...
<div class="row">
    ...
    <form class="form-horizontal tasi-form" id="tab" method="POST" action="<?php echo $_SESSION['host_']?>index.php/create/input_setting/">
	
		<div class="form-group">
          <div class="col-lg-offset-2 col-lg-10">		
			<button class="btn btn-primary"><i class="icon-save"></i> Save</button>
			<!-- #myModal-->
			<a href="<?php echo site_url();?>/create/viewsite_setting" data-toggle="modal" class="btn btn-success">Cancel</a>
		  </div>
		  <!--div class="btn-group">
		  </div-->
		</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-10">
		<input class="form-control" id="setting_name" name="setting_name" type="text" value="<?php echo set_value('setting_name'); ?>" > <?php echo form_error('setting_name'); ?>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-lg-10">
		<input class="form-control" id="setting_value" name="setting_value" type="text" value="<?php echo set_value('setting_value'); ?>" > <?php echo form_error('setting_value'); ?>
		</div>
    </div>
