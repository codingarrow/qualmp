													  ...
													  <section class="panel">
														  ...
														  <table class="table table-hover">
															  ...
															  <tbody>
																 ...
																 ?>
															  <tr>
																  <td><input class="chkDemoCL03" name="checkbox-03[]" id="checkbox03[]" value="<?php echo $squestions['categoryid'];?>" type="checkbox" /><?php echo $squestions['categoryid'];?></td>
											  ...
											  <div class="col-lg-12">
												  ...
												  <header class="panel-heading">Campaigns</header>
													  <table class="table table-hover">
													   ...
													   ?>							  
														  <tr>
															  <td><input  name="checkcampaign[]" id="checkcampaign[]" value="<?php echo $campaign['id'];?>" type="checkbox" /><?php echo $campaign['id']; ?></td>
